...
<section class="cart_sec inner-banner-section IntelliVista_banner">
    <div class="container">
        <div class="row">
            ...
            <div
                ...
                <button class="btn btn-outline-primary w-auto">Cancel
                    order</button>
                <button class="btn btn-primary w-auto ms-4">Proceed to
                    Checkout</button>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-12 mt-lg-0 mt-4 ms-lg-5">
                    ...
                    <div class="card_title">
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-12">
                                <p
                                    class="d-flex align-items-center justify-content-between mb-1 w-100 gap-3">Total : <span><b>$60.00</b></span></p>
                            </div>
                        </div>
                    </div>
                </div>
...
export default Checkout_IntelliVista