...
import { test } from "../components/App/App.jsx";
...
const Checkout = ({ price, amount, main_header, img }, props) => {
    const location = useLocation();
    const { state } = location;
    const { id, name, address, address2, zipcode, city, state: stateValue, phone, email } = state || {}
    ...
    const validationSchema = Yup.object({
        ...
        cardNumber: Yup.string().required("Card number is required!").min(19, "Card number must be 16 digits"),
        expiresOn: Yup.string()
            .required("Expires on is required")
            .length(7, "Invalid date"),
        cvcCvv: Yup.string()
            .required("CVV/CVC is required").min(3, "CVC/CVV must be 3 or 4 digits")
    });
    ...
    const handleExpiresOnChange = (e) => {
        ...
        const formattedValue = `${month} / ${inputValue.slice(2, 4) || ''}`; // Format the input to MM / YY
        formik.handleChange({ target: { name: 'expiresOn', value: formattedValue } });
    };
    ...
    const handleCardNumberChange = (e) => {
        ...
        formik.handleChange({ target: { name: 'cardNumber', value: formattedValue } });
    };
                    ...
                    <div class="row">
                        ...
                        <div
                            ...
                            <button class="btn btn-outline-primary w-auto" onClick={handleCencelOrder}>Cancel
                                order</button>
                            <button class="btn btn-primary w-auto ms-4" type="submit" onClick={formik.handleSubmit}>Proceed to pay</button>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div
                                            ...
                                            <input type="text"
                                                ...
                                                className={`form-control ${formik.touched.nameOnCard && formik.errors.nameOnCard
                                                    ? "is-invalid"
                                                    : ""
                                                    }`}
                                                name="nameOnCard"
                                                ...
                                                invalidFeedback={formik.errors.nameOnCard}
                                            />
                                        ...
                                        <div
                                            ...
                                            <label for class="w-100">Expires on :</label>
                                            <input type="text"
                                                class="form-control"
                                                placeholder="MM / YY"
                                                className={`form-control ${formik.touched.expiresOn && formik.errors.expiresOn
                                                    ? "is-invalid"
                                                    : ""
                                                    }`}
                                                name="expiresOn"
                                                ...
                                                isTouched={formik.touched.expiresOn}
                                                invalidFeedback={formik.errors.expiresOn} />
                                            <div className="invalid-feedback">
                                        ...
                                        <div
                                            ...
                                            <input type="number"
                                                class="form-control"
                                                placeholder="----"
                                                className={`form-control ${formik.touched.cvcCvv && formik.errors.cvcCvv
                                                    ? "is-invalid"
                                                    : ""
                                                    }`}
                                                name="cvcCvv"
                                                onChange={handleCVVOnChange}
                                                onBlur={formik.handleBlur}
                                                value={formik.values.cvcCvv}
                                                isValid={formik.isValid}
                                                isTouched={formik.touched.cvcCvv}
                                                invalidFeedback={formik.errors.cvcCvv} />
                                            <div className="invalid-feedback">
                                                {formik.errors.cvcCvv}
                                            </div>
                                        </div>
                                    </div>
                                </form>
