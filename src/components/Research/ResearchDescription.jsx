...
import topImg from '../../assets/researchTopImg.jpg'
      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col ">
            ...
            <p className="discription ps-3"><span style={{fontWeight:'600'}}>Olfactory dysfunction</span> is a common feature in the older population, and its severity increases with aging. It may manifest early in neurodegenrative diseases as well as mild cognitive impairment and represents an important early clinical symptom suggestive of neurodegeneration.
            </p>
          </div> </div>
              ...
              <div className="col-xs-12 col-sm-6">
                ...
                <div className="row justify-content-center">
                  <div className="col pt-5">
                    <p className="graph-title pt-3"><span style={{fontWeight:'600'}}>Over 13 million people in America</span><br />
                ...
                <div className="row">
                  <div className="col pt-5 ps-5 ms-5">
                    <p className="graph-end-discription">
                      Add reference<br />
