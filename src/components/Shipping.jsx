...
function Shipping({ path }) {
    ...
    // const sixteenItemsPrice = localStorage.getItem('price16Items');
    // const eigthItemsPrice = localStorage.getItem('price8Items');
    // const sixteenItemsQuantity = localStorage.getItem('quantity16Items');
    // const eigthItemsQuantity = localStorage.getItem('quantity8Items');
    // const total = parseFloat(sixteenItemsPrice) + parseFloat(eigthItemsPrice)
    const [sixteenItemsPrice, setSixteenItemsPrice] = useState(0);
    const [eigthItemsPrice, setEigthItemsPrice] = useState(0);
    const [sixteenItemsQuantity, setSixteenItemsQuantity] = useState(0);
    const [eigthItemsQuantity, setEigthItemsQuantity] = useState(0);
    const [total, setTotal] = useState(0);

    useEffect(() => {
        const storedSixteenItemsPrice = parseFloat(localStorage.getItem('price16Items')) || 0;
        const storedEigthItemsPrice = parseFloat(localStorage.getItem('price8Items')) || 0;
        const storedSixteenItemsQuantity = parseInt(localStorage.getItem('quantity16Items')) || 0;
        const storedEigthItemsQuantity = parseInt(localStorage.getItem('quantity8Items')) || 0;
        setSixteenItemsPrice(storedSixteenItemsPrice);
        setEigthItemsPrice(storedEigthItemsPrice);
        setSixteenItemsQuantity(storedSixteenItemsQuantity);
        setEigthItemsQuantity(storedEigthItemsQuantity);
        const calculatedTotal = storedSixteenItemsPrice + storedEigthItemsPrice;
    ...
    const validationSchema = Yup.object({
        zipCode: Yup.string().matches(/^[0-9]+$/, "Zip Code must be number only").required("Zip code is required!"),
        state: Yup.string().required("State is required!"),
        addressLine1: Yup.string(),
        addressLine2: Yup.string(),
        // saveInfoForNextTime: Yup.string(),
    ...
    const handleCencelOrder = () => {
        formik.resetForm();
        // localStorage.removeItem('price16Items');
        // localStorage.removeItem('quantity16Items');
        // localStorage.removeItem('price8Items');
        // localStorage.removeItem('quantity8Items');
        // setSixteenItemsPrice(0);
        // setEigthItemsPrice(0);
        // setSixteenItemsQuantity(0);
        // setEigthItemsQuantity(0);
        // setTotal(0);
    };
        ...
        if (formik.isValid) {
            ...
            navigate("/Checkout", {
                state: {
                    ...
                    email: event.email,
                    sixteenItemsPrice : sixteenItemsPrice,
                    eigthItemsPrice: eigthItemsPrice,
                    sixteenItemsQuantity: sixteenItemsQuantity,
                    eigthItemsQuantity: eigthItemsQuantity,
                    total: total
                },
            });
        } else {
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div
                            ...
                            <button class="btn btn-outline-primary w-auto" onClick={handleCencelOrder}>Cancel
                                order</button>
                            <button class="btn btn-primary w-auto ms-4" type="submit" onClick={formik.handleSubmit}>Proceed to
                                Checkout</button>
                        </div>
                    </div>
                    <form>
                        ...
                        <div class="row">
                                        ...
                                        <div class="row gx-lg-5 gx-3">
                                            ...
                                            <div
                                                ...
                                                <input type="text"
                                                    ...
                                                    class="form-control"
                                                    placeholder="Ship to"
                                                    className={`form-control ${formik.touched.shipTo && formik.errors.shipTo
                                                        ? "is-invalid"
                                                        : ""
                                                        }`}
                                                    onChange={(e) => {
                                                    ...
                                                    isValid={formik.isValid}
                                                    isTouched={formik.touched.shipTo}
                                                    invalidFeedback={formik.errors.shipTo} />
                                                <div className="invalid-feedback">
                                            ...
                                            <div class="col-12 pt-lg-2">
                                                <div
                                                    ...
                                                    // id="saveInfoForNextTime"
                                                    // name="saveInfoForNextTime"
                                                    // checked={formik.values.saveInfoForNextTime}
                                                    // onChange={formik.handleChange} 
                                                    />
                                                    <label for class="ms-3 mb-0"><p
                                                        class="m-0">Save shipping
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 col-12 ps-lg-5">
                                <div class="summary_card">
                                    <div class="card_title">
                                        <h6 class="mb-lg-4 mb-3"><b>Order
                                            summary</b></h6>
                                        <p class="mb-2 text-start">ScentAware 16-item
                                            Smell Test and Training kit</p>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <p
                                                    class="d-flex align-items-center justify-content-between mb-2">Quantity
                                                    : <span>{sixteenItemsQuantity}</span></p>
                                                <p
                                                    class="d-flex align-items-center justify-content-between mb-0">Price
                                                    : <span>{sixteenItemsPrice}</span></p>
                                            </div>
                                        </div>
                                        <hr class="my-lg-4" />
                                        <p class="mb-2 text-start">SScentAware 8-item
                                            Smell Test and Training
                                            kit</p>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <p
                                                    class="d-flex align-items-center justify-content-between mb-2">Quantity
                                                    : <span>{eigthItemsQuantity}</span></p>
                                                <p
                                                    class="d-flex align-items-center justify-content-between mb-0">Price
                                                    : <span>{eigthItemsPrice}</span></p>
                                            </div>
                                        </div>
                                        <hr class="my-lg-4" />
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <p
                                                    class="d-flex align-items-center justify-content-between mb-1">Total : <span><b>{total}</b></span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
