          ...
          <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a onClick={(e)=>{navigate('/')}} class="nav-link" href="#">
                    Academics
                  </a>
                </li>
                <li class="nav-item">
                  <a onClick={(e)=>{navigate('/')}} class="nav-link" href="#tutorials">
                    Tutorials
                  </a>
                </li>
                <li class="nav-item">
                  <a onClick={(e)=>{navigate('/')}} class="nav-link" href="#shop" >
                    Shop
                  </a>
                </li>
                <li class="nav-item-icon-cart cart-mobile">
                  ...
                  >
                    <img src={carticon} alt="Cart_icon" />
                    <i class="fa font">&#xf07a;</i>
                    <span class='badge badge-warning' id='lblCartCount'> {TotalAmount}{" "} </span>
                  </Link>
                </li>
