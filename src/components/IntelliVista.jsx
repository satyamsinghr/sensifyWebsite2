...
import Question_icon from "../../src/assets/Queastion_icon.png";
import edit_icon from "../../src/assets/edit_icon.png";
import sea_img from "../../src/assets/sea_img.png";
import { Outlet, Link } from "react-router-dom";
import Filter_icon from "../../src/assets/Filter_icon.png";
import logoBlack from "../assets/logo-black.png";
import IntelliVistaImg from "../assets/IntelliVista.png";
import do_for_you from "../assets/do_for_you.png";
import analysis from "../assets/analysis.png";
import medical from "../assets/medical.png";

export default function IntelliVista() {
  ...
  return (
    ...
    <header class="inner_header">
                    ...
                    <div class="col-12">
                        <nav class="navbar navbar-expand-lg p-0">
                            ...
                            <div class="collapse navbar-collapse"
                                ...
                                {/* <div class="dont_account ms-lg-4 ms-md-4">
                                    <button
                                        class="btn btn-primary w-auto">Log
                                        in</button>
                                </div> */}
                            </div>
                        </nav>
        ...
        <section class="inner-banner-section IntelliVista_banner">
            <div class="container">
                <div class="row">
                    <div
                        class="col-lg-5 col-md-12 col-sm-12 col-12 d-flex align-items-center">
                        <div class="card_title banner_content">
                            <h2 class="mb-4 pb-lg-3">Collect data for research
                                or for your
                                organization.</h2>
                            <p class="text-start">IntelliVista is a HIPAA
                                compliant data management
                                tool<br /> that securely manages your data. It
                                gathers
                                in-depth data<br /> from the tests performed via
                                the
                                SensifyAware App and <br />provides detailed
                                visual
                                infographics of how the <br />participants
                                perform.</p>
                            <a href="#"
                                class="btn btn-primary w-auto mt-4 pt-lg-3">Subscribe
                                now</a>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="banner_img">
                            <img src={IntelliVistaImg} width="100%" alt/>
                        </div>
                    </div>
                </div>
            </div>
        </section>
        <section class="do_for_you">
            <div class="container">
                <div class="row g-3">
                    <div class="col-lg-5 col-md-12 col-sm-12 col-12">
                        <div class="do_for_img">
                            <img src={do_for_you} width="100%" alt/>
                        </div>
                    </div>
                    <div
                        class="col-lg-6 col-md-12 offset-lg-1 col-sm-12 col-12">
                        <div class="card_title">
                            <p class="mb-0 text-start">Place tagline here</p>
                            <h2 class="my-4 py-lg-2">What does IntelliVista do
                                for you?</h2>
                            <div class="row">
                                <div
                                    class="col-lg-6 col-md-6 col-sm-12 col-12 pe-lg-5">
                                    <img src={analysis} alt/>
                                    <p class="my-3 text-start"><b>Simplified
                                            Testing and Analysis</b></p>
                                    <p class="text-start m-0">IntelliVista
                                        offers secure remote data capture and a
                                        choice between at-home or in-clinic test
                                        administration, complemented by
                                        effortless data retrieval for
                                        streamlined analysis.</p>
                                </div>
                                <div
                                    class="col-lg-6 col-md-6 col-sm-12 col-12 pe-lg-5">
                                    <img src={medical} alt/>
                                    <p class="my-3 text-start"><b>HIPAA
                                            Compliant Data Management</b></p>
                                    <p class="text-start m-0">IntelliVista
                                        ensures the utmost data safety with its
                                        HIPAA-compliant cloud infrastructure,
                                        providing a foundation for safe and
                                        secure data management.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="cost_effect">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                        <div class="card_title">
                            <div class="row">
                                <div class="col-lg-10 col-md-12 col-sm-12 col-12 mb-lg-5 mb-md-4 mb-4">
                                    <h2 class="mb-3 pb-lg-1">Cost effective
                                        annual plans.</h2>
                                    <p class="text-start m-0">Sorem ipsum dolor
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                    <div class="plan_card">
                                        ...
                                        <ul class="my-4 py-lg-2">
                                            <li>1 administrator account login.</li>
                                            <li>Add up to 10,000 participants in a clinical study.</li>
                                            <li>Create unlimited trials.</li>
                                        </ul>
                                        <h2 class="mb-0">$4,995/year</h2>
                                        <button class="btn btn-primary w-auto my-4">Subscribe</button>
                                        <p class="text-start m-0">Please review our Terms & Conditions</p>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                    <div class="plan_card">
                                        <h6 class="mb-3"><b>Custom Plan</b></h6>
                                        <form action="">
                                            <div class="row mb-3">
                                                <div class="col-lg-5 col-md-12 col-sm-12 col-12 d-flex align-items-center">
                                                    <p class="text-start m-0">Administrators :</p>
                                                </div>
      ...
      {/* <div className="aspire-todo">
        <p className="we-aspire">
          We aspire to change the course
          <br /> of neuro-degenerative diseases
          <br /> through early screening,
        </p>
        <p className="to-do-just">
          to do just that we have developed tools for
          <br /> individuals and clinical research
        </p>
      </div>

      <div className="intelli-back">
        <div className="heading-para">
          <div>
            <h2>IntelliVista,</h2>
            <p>
              A real-time data collection and analysis<br></br> tool for
              clinical research.
            </p>
          </div>
        </div>
      ...
      <div className="whatdoes">
        <Row>
          <Col lg={24}>
            <div className="does-IntelliVista">
              <h1>What does IntelliVista do for you?</h1>
            </div>
          </Col>
        </Row>

        <Row className="four-section">
          <Col lg={7} sm={12}>
            <div className="que-section">
              <img className="icons0" src={Question_icon} />
              <h4>
                Address clinical questions that
                <br /> you couldn’t before.
              </h4>
            </div>
          </Col>
          ...
          <Col lg={7} sm={12}>
            <div className="edit-section">
              <img className="icons0" src={edit_icon} />
              <h4>
                Customize your tests and
                <br /> analysis.
              </h4>
            </div>
          </Col>
        ...
        <Row className="four-section">
          <Col lg={7} sm={12}>
            <div className="sea-section">
              <img className="icons0" src={sea_img} />
              <h4>
                Detect preclinical stages of
                <br /> neuro-degenerative diseases
                <br /> with predictive analysis.
              </h4>
            </div>
          </Col>
          ...
          <Col lg={7} sm={12}>
            <div className="filter-section">
              <img className="icons0" src={Filter_icon} />
              <h4>
                Remote monitoring and
                <br /> longitudinal analysis.
              </h4>
            </div>
          </Col>
        </Row>
        ...
        <Row>
          <Col lg={24}>
            <h5 className="much-more">
              And much more. Click on the link below to find out,
            </h5>
          </Col>
        </Row>
        ...
        <Row>
          <Col lg={24}>
            <button className="btn-learn-more" onClick={(e) => { navigate('/collaboration#contactUst') }}>
              Learn more about IntelliVista
            </button>
          </Col>
        </Row>
      </div> */}
