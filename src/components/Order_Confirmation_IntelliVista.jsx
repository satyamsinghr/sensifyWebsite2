    ...
    <div>  
        ...
        <section
            ...
            <div className="container">
                <div className="row">
                    <div
                        className="col-lg-7 pe-lg-5 col-md-12 col-sm-12 col-12">
                        <div className="card_title">
                            <h2 style={{fontWeight: 300,color: '#4E4E4E'}}
                                className="mb-4 pb-lg-2">Subscription
                                confirmed!</h2>
                            <h6 className="mb-2">Thank you for choosing
                                IntelliVista! Your annual
                                subscription has been successfully
                                activated.</h6>
                            <p className="text-start mb-0">Welcome to IntelliVista!
                            ...
                            <div className="mt-4 pt-lg-2">
                                <button className="btn btn-primary w-auto">Access
                                    the Dashboard</button>
                                <button
                                    className="btn btn-outline-primary w-auto ms-4">Go to homepage</button>
                            </div>
                            <h6 className="mb-3 mt-4 pt-lg-2" style={{color: '#000'}}>Subscription details
                                -</h6>
                            <div className="row">
                                <div
                                    className="col-lg-4 col-md-12 col-sm-12 col-12 border-end confirmation pe-lg-3">
                                    <p
                                        className="mb-2 text-start"><b>IntelliVista
                                            -
                                            Basic plan</b></p>
                                    <ul>
                                        <li className="text-nowrap">1 administrator
                                            account
                                            login.</li>
                                ...
                                <div
                                    className="col-lg-7 col-md-12 col-sm-12 col-12 ps-lg-3 subscription_detail">
                                    <p
                                        className="d-flex align-items-center text-start gap-4 mb-2"><span>Subscription
                                            start date
                                    ...
                                    <p
                                        className="d-flex align-items-center text-start gap-4 mb-2"><span>Transaction
                                            ID :</span>5633AGLPO124I</p>
                                    <p
                                        className="d-flex align-items-center text-start gap-4 mb-2"><span>Payment
                                            method :</span>Credit card ending
                                        with 0379</p>
                                    <p
                                        className="d-flex align-items-center text-start gap-4 mb-1"><span>Amount
                                            paid : </span>$4,995.00</p>
                                    <p
                                        className="d-flex align-items-center text-start bill_time m-0">(Billed
                                        annually)</p>
                                </div>
                                <div className="col-12">
                                    <p className="text-start m-0 mt-4 pt-lg-2">Your annual subscription will
